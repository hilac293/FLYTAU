...
VALUES
-- תל אביב - נתב״ג → לונדון
('2026-03-06 07:00:00', 'תל אביב - נתב״ג', 'לונדון', 'active', 1200.00, 2000.00, 2001),
('2026-03-06 19:00:00', 'תל אביב - נתב״ג', 'לונדון', 'active', 1250.00, 2100.00, 2002),
('2026-03-15 10:00:00', 'תל אביב - נתב״ג', 'לונדון', 'active', 1300.00, 2200.00, 2001),
-- תל אביב - נתב״ג → פריז
('2026-03-07 09:00:00', 'תל אביב - נתב״ג', 'פריז', 'active', 1100.00, 1900.00, 2002),
('2026-03-07 17:00:00', 'תל אביב - נתב״ג', 'פריז', 'active', 1150.00, 1950.00, 2001),
('2026-03-20 14:00:00', 'תל אביב - נתב״ג', 'פריז', 'active', 1200.00, 2000.00, 2002),
-- תל אביב - נתב״ג → ניו יורק
('2026-03-08 08:00:00', 'תל אביב - נתב״ג', 'ניו יורק', 'active', 1500.00, 2500.00, 1001),
('2026-03-08 22:00:00', 'תל אביב - נתב״ג', 'ניו יורק', 'active', 1550.00, 2600.00, 1002),
('2026-03-18 15:00:00', 'תל אביב - נתב״ג', 'ניו יורק', 'active', 1600.00, 2700.00, 1001),
-- אילת → לונדון
('2026-03-10 07:00:00', 'אילת', 'לונדון', 'active', 1250.00, 2150.00, 2002),
('2026-03-10 18:00:00', 'אילת', 'לונדון', 'active', 1300.00, 2200.00, 2001),
-- אילת → פריז
('2026-03-12 09:00:00', 'אילת', 'פריז', 'active', 1200.00, 2100.00, 2002),
('2026-03-12 21:00:00', 'אילת', 'פריז', 'active', 1250.00, 2150.00, 2001);
